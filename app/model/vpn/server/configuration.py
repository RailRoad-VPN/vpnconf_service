...
class VPNServerConfiguration(object):
    ...
    def __init__(self, suuid: str = None, user_uuid: str = None, server_uuid: str = None, platform_id: int = None,
                 file_path: str = None, configuration: str = None, version: int = None):
        self._suuid = suuid
...
class VPNServerConfigurationStored(StoredObject, VPNServerConfiguration):
    ...
    def __init__(self, storage_service: StorageService, suuid: str = None, user_uuid: str = None,
                 server_uuid: str = None, platform_id: int = None, file_path: str = None, configuration: str = None,
        ...
        VPNServerConfiguration.__init__(self, suuid=suuid, user_uuid=user_uuid, server_uuid=server_uuid,
                                        platform_id=platform_id, file_path=file_path, configuration=configuration,
                                        version=version)
...
class VPNServerConfigurationDB(VPNServerConfigurationStored):
    ...
    def create(self):
        ...
        insert_sql = '''
                      INSERT INTO public.vpnserver_configuration 
                        (uuid, server_uuid, platform_id, user_uuid, file_path, configuration) 
                      VALUES 
                        (?, ?, ?, ?, ?, ?)
                     '''
        insert_params = (
    ...
    def __map_vpnserverconfigdb_to_vpnserverconfig(self, vpnserverconfig_db):
        return VPNServerConfiguration(
            ...
            platform_id=vpnserverconfig_db[self._platform_id_field],
